...
const navigationCards = [
  {
    title: 'My Story',
    description: 'Learn about my journey and experiences',
    href: '/story',
    icon: (
      <svg
  ...
  {
    title: 'My Blog',
    description: 'Read my thoughts and technical articles',
    href: '/blog',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    title: 'My Projects',
    description: 'Explore my portfolio of work and code',
    href: '/projects',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/alfredo-mejia',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/alfredo_mejia',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-16">
      <div className="w-full max-w-2xl">
        ...
        <header className="text-center">
          <h1 className="text-[2.5rem] font-bold tracking-tight text-[#242424] sm:text-[3rem]">
            Alfredo Mejia
          </h1>
        ...
        <div className="mt-8 flex justify-center">
          <a
            href="/resume.pdf"
            download
            className="inline-flex items-center gap-2 rounded-full border border-[#242424] bg-[#242424] px-6 py-3 text-[0.875rem] font-medium text-white transition-all hover:bg-white hover:text-[#242424]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((link) => (
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full text-[#555555] transition-colors hover:bg-[#F5F5F5] hover:text-[#242424]"
